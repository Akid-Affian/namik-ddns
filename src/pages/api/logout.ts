...
export const POST: APIRoute = async ({ request }) => {
  ...
  if (authToken) {
    ...
    headers.append('Set-Cookie', 'admin_cookie=; Path=/; Secure; Max-Age=0; SameSite=Strict');
    headers.append('Set-Cookie', 'superadmin_cookie=; Path=/; Secure; Max-Age=0; SameSite=Strict');
